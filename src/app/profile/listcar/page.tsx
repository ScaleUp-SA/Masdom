        ...
        <div className="px-8 pb-8 min-h-screen flex flex-col gap-6 items-center">
          ...
          <div className="flex flex-col w-4/5 gap-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                handleInputChange("offerDetails", e.target.value)
              }
            ></textarea>
          </div>
          ...
          <div className="flex flex-col items-start gap-4 mt-6 w-4/5">
            ...
            <div className="flex flex-col w-full gap-2">
              <label>مكان الصدمة</label>
              <textarea
                required
                placeholder="مكان الصدمة"
                className="max-h-24 rounded p-2 border"
                value={formData.collisionLocation}
                onChange={(e) =>
                  handleInputChange("collisionLocation", e.target.value)
                }
              ></textarea>
            </div>
          </div>
